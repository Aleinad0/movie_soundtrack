...
--- 3. import raw data (done manually on PgAdmin)
...
-- CLEANING DATABASE
-- 1. Remove trailing spaces in artist_name column

UPDATE artists
SET artist_name = RTRIM(artist_name);

-- 2. Remove trailing spaces in movie_name

UPDATE movies
SET movie_name = RTRIM(movie_name);

-- 3. Remove trailing spaces in recordings

UPDATE recordings
SET song_name = RTRIM(song_name);
