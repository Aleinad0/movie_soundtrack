...
df = pd.read_csv('Daniela\sound_track_imdb_top_250_movie_tv_series.csv', delimiter=",", index_col=0)
...
df_selected.to_csv("Daniela/filtered_movie_songs_no_idx.csv", index=False)